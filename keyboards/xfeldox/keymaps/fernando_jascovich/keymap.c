...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        LOWER,    MO(_EMACS),       TD(TD_CTRL_LALT),
        KC_Y,     KC_U,             KC_I,    KC_O,   KC_P,
        KC_H,     KC_J,             KC_K,    KC_L,   TD(TD_SHIFT),
        KC_N,     KC_M,             KC_COMM, KC_DOT, ALGR_T(KC_SLASH),
        KC_SPACE, LGUI_T(KC_ENTER), RAISE
        ),

    /* Dvorak */
    [_DVORAK] = LAYOUT (
        ALGR_T(KC_SLASH), KC_COMM,          KC_DOT, KC_P, KC_Y,
        KC_A,             KC_O,             KC_E,   KC_U, KC_I,
        TD(TD_SHIFT),     KC_Q,             KC_J,   KC_K, KC_X,
        LOWER,            MO(_EMACS),       TD(TD_CTRL_LALT),
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_GRV,
        KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PIPE,
    ...
    /* Raise */
    [_RAISE] = LAYOUT(
    	KC_ESC,           KC_CIRC,       KC_ASTR,  KC_PLUS,   KC_PERC,
        KC_CAPS,          KC_TILD,       KC_SLASH, KC_MINUS,  KC_EQL,
        KC_COLN,          KC_SCLN,       KC_QUOT,  KC_DQUO,   KC_UNDS,
        _______,          _______,       KC_TAB,
        ALGR(LSFT(KC_1)), ALGR(KC_SLSH), KC_AT,    KC_DOLLAR, KC_DEL,
        KC_EXLM,          KC_QUES,       KC_HASH,  KC_AMPR,   XXXXXXX,
        XXXXXXX,          XXXXXXX,       XXXXXXX,  XXXXXXX,   TG(_MOUSE),
        _______,          _______,       _______
        ),
    ...
    [_ADJUST] = LAYOUT(                         \
        ...
        _______,  _______,     _______,
        KC__MUTE, KC__VOLDOWN, KC__VOLUP,           KC_F14,        KC_F15,
    ...
    /*Emacs*/
    [_EMACS] = LAYOUT(                          \
        EM_SPLIT_NONE, EM_SPLIT_H,   EM_SPLIT_V,  EM_W_INC_V,  EM_W_INC_H,
